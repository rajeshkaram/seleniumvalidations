...
public class BaseClass 
{
	...
	public void setupTestSuite()
	{
			...
			report=new ExtentReports(System.getProperty("user.dir")+"/Reports/"+Utility.Utility.getCurrentDateTime()+".html");
	...
	public void endLogger(ITestResult result)
	{
		...
		{
			String path=Utility.Utility.captureScreenshot(driver);
